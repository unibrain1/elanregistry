...
if (!empty($_POST)) {
  ...
  if(!empty($_POST['addUser'])) {
    ...
    $userData = $db->query("SELECT car_user.carid, users.* FROM users LEFT JOIN car_user ON users.id = car_user.userid ")->results();
              ...
              <div class="row">
                <div class="col-xs-12">
                  ...
                  <div class="allutable">
                    ...
                    <table id="paginate" class='display'>
                      <thead>
                        <tr>
                          <th>ID</th>Pass<th></th><th>Username</th><th>Name</th><th>Email</th>
                          <th>Last Sign In</th><?php if($act==1) {?><th>Verified</th><?php } ?><th>Status</th><th>CarID</th>
                        </tr>
                      </thead>
                      <tbody>
                        <?php
