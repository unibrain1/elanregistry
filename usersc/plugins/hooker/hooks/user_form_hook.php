...
<table id="accounttable" width="100%" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">	
	...
	<tr ><td ><strong>LAT	          : </strong></td><td ><?= html_entity_decode($thatUser[0]->lat);?></td></tr>
	<tr ><td ><strong>LON	          : </strong></td><td ><?= html_entity_decode($thatUser[0]->lon);?></td></tr>
	<tr ><td ><strong>CAR ID          : </strong></td><td ><?= html_entity_decode($thatUser[0]->id);?></td></tr>
	<tr ><td ><strong>YEAR            : </strong></td><td ><?= html_entity_decode($thatUser[0]->year);?></td></tr>
	<tr ><td ><strong>TYPE			  : </strong></td><td ><?= html_entity_decode($thatUser[0]->type);?></td></tr>
	<tr ><td ><strong>CHASSIS		  : </strong></td><td ><?= html_entity_decode($thatUser[0]->chassis);?></td></tr>
</table>
