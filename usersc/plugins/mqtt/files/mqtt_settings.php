...
if(!empty($_POST)){
  ...
  Redirect::to($us_url_root."users/mqtt_settings.php?err=New+server+added");
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <p>
          MQTT serves two purposes in UserSpice.  It is the "wiring" of the Internet of Things world and now UserSpice can be part of that world. Additionally, this page serves to provde mqtt code on how to use our OCE (One Click Edit) system. Feel free to look at the PHP on this page to see how to use OCE.
        </p>
