...
<!-- Bootstrap Core CSS -->
<link rel="stylesheet" href="<?=$us_url_root?>usersc/templates/light/assets/css/bootstrap.min.css">
...
<script src="<?=$us_url_root?>usersc/templates/light/assets/js/bootstrap.min.js" type="text/javascript"></script>
...
<?php require_once($abs_us_root.$us_url_root.'usersc/templates/light/assets/functions/style.php');?>
...
require_once($abs_us_root.$us_url_root.'usersc/templates/light/assets/functions/nav.php');
}


 if($settings->navigation_type==1) {
 require_once($abs_us_root.$us_url_root.'usersc/templates/light/assets/functions/dbnav.php');
} ?>
...
<?php
if(isset($_GET['err'])){
		bold("<br><center><span style='background-color:black;color:red'>".$err."</span></center>");
	}

	if(isset($_GET['msg'])){
		bold("<br><center><span style='background-color:black;color:white'>".$msg."</span></center>");
	}
require_once $abs_us_root . $us_url_root . 'usersc/templates/bs4/container_open.php'; //custom template container

require_once $abs_us_root . $us_url_root . 'usersc/templates/light/container_open.php'; //custom template container
?>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div role="alert" class="mt-1 alert alert-info alert-dismissible fade show">
                            <button type="button" data-dismiss="alert" aria-label="Close" class="close"><span aria-hidden="true">x</span></button> <span class="font-weight-bold">Heads up!</span> Vestibulum tincidunt ullamcorper eros eget luctus. Nulla <a href="#" class="alert-link">info</a> porttitor libero.
                        </div>
                        <div role="alert" class="mt-1 alert alert-danger alert-dismissible fade show">
                            <button type="button" data-dismiss="alert" aria-label="Close" class="close"><span aria-hidden="true">x</span></button> <span class="font-weight-bold">Yo there!</span> You should check <a href="#" class="alert-link">danger</a> in on some of those fields below.
                        </div>
                        <div role="alert" class="mt-1 alert alert-warning alert-dismissible fade show">
                            <button type="button" data-dismiss="alert" aria-label="Close" class="close"><span aria-hidden="true">x</span></button>
                    ...
                    <div class="col-sm-6">
                        <div role="alert" class="mt-1 alert alert-primary bg-primary text-white alert-dismissible fade show">
                            <button type="button" data-dismiss="alert" aria-label="Close" class="close"><span aria-hidden="true">x</span></button> <span class="font-weight-bold">Womp!</span> Vestibulum tincidunt ullamcorper eros eget luctus. Nulla porttitor libero.
                        </div>
                        <div role="alert" class="mt-1 alert alert-danger bg-danger text-white alert-dismissible fade show">
                            <button type="button" data-dismiss="alert" aria-label="Close" class="close"><span aria-hidden="true">x</span></button> <span class="font-weight-bold">Danger!</span> Vestibulum tincidunt ullamcorper eros eget luctus. Nulla porttitor libero.
                        </div>
                        <div role="alert" class="mt-1 alert alert-success bg-success alert-dismissible fade show">
                            <button type="button" data-dismiss="alert" aria-label="Close" class="close"><span aria-hidden="true">x</span></button> <span class="font-weight-bold">Success!</span> Vestibulum tincidunt ullamcorper eros eget luctus. Nulla porttitor libero.
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content text-center">
                            <div class="modal-body text-center">
                                ...
                                </div> <a data-dismiss="modal"><span aria-hidden="true" class="display-2">x</span></a></div>
                        </div>
                    </div>
                </div>
...
<?php require_once $abs_us_root . $us_url_root . 'usersc/templates/light/container_close.php'; //custom template container  ?>

<?php require_once $abs_us_root . $us_url_root . 'users/includes/page_footer.php'; ?>

<?php require_once $abs_us_root . $us_url_root . 'usersc/templates/light/footer.php'; //custom template footer ?>
