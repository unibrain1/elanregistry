...
// Set up notifications button/modal
        ...
        <div class="col-md-3 float-left col-1 pl-0 pr-0 width collapse show" id="sidebar" aria-expanded="true">
          ...
          <?php } ?>
                ...
                <a href="#menu1" class="list-group-item d-inline-block collapsed" data-toggle="collapse" aria-expanded="false"><i class="fa fa-cog"></i> <span class="d-none d-md-inline">User Settings</span> </a>
  ...
  <span class="hamburger-box">
    <span class="hamburger-inner"></span>
        ...
        <div class="" style="background-color: #373a3c;">
...
// Set up notifications button/modal
  ...
  <span class="hamburger-box">
    <span class="hamburger-inner"></span>
             ...
             <div class="" style="background-color: #373a3c;">
                 <div class="text-center">
    <a style="right:-35px;position: relative;" href="<?= $us_url_root ?>"><img src="<?= $us_url_root ?>users/images/logo.png"></img></a>
                 </div>
             </div>
             <?php }
    if ($settings->navigation_type == 1) {
...
if(isset($_GET['err'])){
		bold("<center><strong><span style='color:red'>".$err."</span></strong></center>");
	}

	if(isset($_GET['msg'])){
		bold("<center><strong><span style='color:black'>".$msg."</span></strong></center>");
	}
