...
<p>Your name, email, location, and website (set once in Account Settings, not per car) are copied onto every car you own whenever you save your profile — including when you clear a field, which clears it on every car too.</p>
...
<p>Every verification email includes a one-click link to stop receiving them — no login required. If your email is marked as spam-suppressed, you can turn verification emails back on yourself from Account Settings at any time. If your email bounced because the address itself no longer works, verification emails resume automatically as soon as you confirm a working email address — there's no separate switch to flip for that case. (Automated verification emails are rolling out over the next few releases; this section describes how they'll work once they're live.)</p>
