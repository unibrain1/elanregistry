...
<p>Automated verification emails are rolling out over the next few releases; this section describes how they'll work once they're live. Every verification email will include a one-click link to stop receiving them, no login required. If your email is marked as spam-suppressed, you'll be able to turn verification emails back on yourself from Account Settings at any time. If your email bounced because the address itself no longer works, verification emails will resume automatically as soon as you confirm a working email address; there's no separate switch to flip for that case.</p>
