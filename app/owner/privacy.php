...
<p>Your name, email, location, and website (set once in Account Settings, not per car) are copied onto every car you own whenever your profile changes — including when you clear a field, which clears it on every car too.</p>
