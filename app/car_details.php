...
if (!empty($_GET)) {
	...
	$carData = $db->findById($car_id, 'cars')->results();
	$carImages = $db->get('images', ['carid', '=', $car_id])->results();

	$carHist = $db->query('SELECT * FROM cars_hist WHERE car_id=? ORDER BY timestamp DESC, operation ASC', [$car_id])->results();
			...
			<div class="col-sm-6">
				...
				<div class="card card-default">
					...
					<div class="card-body">
						...
						<?php include($abs_us_root . $us_url_root . 'app/views/_carousel.php'); ?>
