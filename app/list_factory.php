...
<div id="page-wrapper">
  ...
  <br>
	<div class="jumbotron text-white bg-primary"> 	<H2>WARNING</h2><p>I've lost track of where this data originated and it may be incomplete, inaccurate, false, or just plain made up.</p></div>
    <div class="col-12" >
