    ...
    <div class="card-body">
        ...
        <form method='POST' id='addCar' name='addCar' action='edit_car.php' enctype='multipart/form-data' class='needs-validation' novalidate>
            <div class="form-group row">
                <label for="carid" class="col-3 col-form-label">Car ID</label>
                <div class="col-sm-1">
                    <div id='carid' class='input-group-prepend'> </div>
                </div>
            </div>
            <!-- Year -->
            <div class="form-group row">
            ...
            <button class='float-right btn btn-success btn-lg' type='submit' id='submit'>Add</button>
            <button class='float-right btn btn-info btn-lg' href="<?= $cancelPage ?>">Cancel </button>
        </form>
    </div>
</div>