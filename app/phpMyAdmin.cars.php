 ...
 *       phpMyEdit.class.php core class: 1.225
 *            phpMyEditSetup.php script: 1.53
 *              generating setup script: 1.53
*/

// MySQL host name, user name, password, database, and table
$opts['hn']  = 'localhost';
$opts['un']  = 'elanregi_reg';
$opts['pw']  = 'LCVFNud6$#U^!^1958kc';
$opts['db']  = 'elanregi_reg';
$opts['tb']  = 'cars';
$opts['ssl'] = 0;
